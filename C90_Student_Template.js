...
function add() {
	...
	backgroundImgTag.onloading = uploadBackground; // ajustando uma função, onloading essa variável
...
function uploadBackground() {
	...
	*/
	canvas.DrawImage(backgroundImgTag, 0, 0, canvas.width, canvas.height);
}
...
function uploadcar1() {
	...
	Corrija os nomes das funções
	*/
	car1.DrawImage(car1ImgTag, car1X, car1Y, car1Width, car1Height);
}
function uploadcar2() {
	/*
	Corrija os nomes das funções
	*/
	car2.DrawImage(car2ImgTag, car2X, car2Y, car2Width, car2Height);
}
